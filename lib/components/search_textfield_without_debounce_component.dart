...
class SearchTextfieldWithoutDebounceComponent extends StatelessWidget {
  ...
  const SearchTextfieldWithoutDebounceComponent({ Key? key, required this.label, required this.hint, required this.controller,
  required this.onChanged, required this.onSubmitted }) : super(key: key);
